...
const positions = {
   ...
   let randomized = Math.floor(Math.random() * Object.keys(positions).length);
    ...
    const gameCreatedAt = Date.now();
		...
		const filter = button => {
			return button.user.id === options.message.author.id;
		};
